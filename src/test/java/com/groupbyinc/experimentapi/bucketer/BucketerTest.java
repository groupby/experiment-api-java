...
public class BucketerTest {
  ...
  public void testHashReturnsExpectedBucketsNoOffset() throws Exception {
    String[] testStrings = getTestStrings("src/test/resources/testStrings.csv");
  ...
  private static String[] getTestStrings(String path) throws FileNotFoundException {
    return new Scanner(new File(path)).nextLine().split(",");
  }
  ...
  public void testHashReturnsExpectedBuckets15Offset() throws Exception {
    ...
    String[] expBucketsStr = getTestStrings("src/test/resources/expectedBuckets15Offset.csv");
    int[] expectedBuckets = new int[expBucketsStr.length];
  ...
  @Test
  public void testMapsFractionsToThresholds() {
  ...
  @Test
  public void testPlaceInBucketFirstBucket() {
    long hashValue = 3L;
  ...
  @Test
  public void testPlaceInBucketLastBucket() {
    long hashValue = 9L;
  ...
  @Test
  public void testPlaceInBucketLowerBound() {
    long hashValue = 1L;
  ...
  @Test
  public void testPlaceInBucketUpperBound() {
    long hashValue = 11L;
    long[] thresholds = new long[]{2L, 5L, 8L, 10L};
    assertEquals(-1, placeInBucket(hashValue, thresholds));
  }
  ...
  @Test
  public void testGenerateBucketsFractionsReturnsAsExpected() {
